...
public class CustomerArgumentResolver
     ...
     * @throws Exception
     */
    protected Object convertAttributeToParameterValue(String sourceValue, String attributeName, MethodParameter parameter, WebDataBinderFactory binderFactory, NativeWebRequest request)
            throws Exception {
        /**
         * 获取类型转换业务逻辑实现类
         */
    ...
    protected final Map<String, String> getUriTemplateVariables(NativeWebRequest request) {
        log.debug("HandlerMapping.URI_TEMPLATE_VARIABLES_ATTRIBUTE : {}", HandlerMapping.URI_TEMPLATE_VARIABLES_ATTRIBUTE);
